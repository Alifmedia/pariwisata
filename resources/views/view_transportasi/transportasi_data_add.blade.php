    ...
    <div class="container my-4">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <form action="{{ route('transportasi.create') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
              <div class="col-6">
                ...
                <div class="form-group">
                  <label>Manajer</label>
                  <input type="text" class="form-control{{ $errors->has('manajer') ? ' is-invalid' : '' }}" name="manajer" value="{{ old('manajer') }}" placeholder="Manajer" required>
