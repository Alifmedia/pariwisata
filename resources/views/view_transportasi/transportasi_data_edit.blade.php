...
@section('content')
  <div id="transportasi-add">
    ...
    <div class="container my-4">
      ...
      <div class="card">
        <div class="card-body">
          <h3 class="card-title">Tambah Transportasi</h3>
          <form action="{{ route('transportasi.update') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
              <div class="col-6">
                ...
                <div class="form-group">
                  <label>Manajer</label>
                  <input type="text" class="form-control{{ $errors->has('manajer') ? ' is-invalid' : '' }}" name="manajer" value="{{ $data->manajer }}" placeholder="Manajer" required>
                  @if ($errors->has('manajer'))
                      <span class="invalid-feedback" role="alert">
                          <strong>{{ $errors->first('manajer') }}</strong>
                      </span>
                  @endif
                </div>
