@extends('view_money_changer.money_changer')

@section('sub-content')
  <div id="data">
    @include('template.flash')
    <form id="search-form" action="{{ route('money_changer') }}" method="get">
      <div class="search">
    ...
    {{-- Table --}}
    <br>
    <form id="delete-form" action="{{ route('money_changer.delete') }}" method="POST">
      @csrf
      <button type="submit" class="btn btn-danger" name="button">
        <i class="fa fa-trash" aria-hidden="true"></i>&nbsp;
        Hapus
      </button>
      <a class="btn btn-primary" href="{{ route('money_changer.create') }}">
            ...
            <tbody>
              @foreach ($datas as $key => $data)
                <tr>
                  ...
                  <td>{{ $data->no_hp }}</td>
                  <td>
                    <a href="{{ route('money_changer.show', $data->id) }}">
                      <i class="fa fa-ellipsis-h" aria-hidden="true"></i>
                    </a>
                  </td>
                  <td>
                    <a href="{{ route('money_changer.edit', $data->id) }}">
                      <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                    </a>
                  </td>
                </tr>
