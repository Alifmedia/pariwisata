...
// };
// var phri = ['Ya', 'Tidak'];
// var status = [ 'Aktif', 'Non-Aktif' ];
// var tipeBiroPer = [ 'BPW', 'APW' ];
// var tipeObjWis = [ 'Bangunan', 'Benda', 'Makam', 'Taman', 'Monumen', 'Rumah', 'Tugu', 'Situs', 'Masjid' ];
// var tipeKuliner = [ 'Rumah Makan', 'Warung', 'Cafe', 'Restoran', 'Bakery' ];
// var bahasa = [ 'Inggris', 'Arab', 'Jerman', 'Prancis', 'Mandarin' ];
// var bidangSanggar = ['Tari', 'Teater', 'Tarik Suara', 'Trsadisional', 'Tutur' ];
//
//
...
//   addOption($('#akomodasi #data #filter6'), status);
// }
//
...
// }
//
// if ($('#pramuwisata').length) {
//   addOption($('#pramuwisata #data #filter1'), kecamatan);
//   addResponsiveOption($('#pramuwisata #data #filter2'), $('#pramuwisata #data #filter1') , gampong);
//   addOption($('#pramuwisata #data #filter3'), status);
//   addOption($('#pramuwisata #data #filter4'), bahasa);
// }
//
// if ($('#sanggar_wisata')) {
//   addOption($('#sanggar_wisata #data #filter1'), bidangSanggar);
//   addOption($('#sanggar_wisata #data #filter2'), kecamatan);
//   addResponsiveOption($('#sanggar_wisata #data #filter3'), $('#sanggar_wisata #data #filter2') , gampong);
// }
